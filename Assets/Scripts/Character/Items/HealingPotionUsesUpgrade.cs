...
namespace JO
{
    public class HealingPotionUsesUpgrade : MonoBehaviour
    {
        ...
        private void OnTriggerEnter(Collider other)
        {
            if (other.CompareTag("Player"))
            {
                ...
                uiPopUpManager.UpdateInteractionText("PRESS F: PICK UP POTION USES UPGRADE");
        ...
        private void PotionInteract()
        {
            ...
            PlayerUIPopUpManager uiPopUpManager = FindFirstObjectByType<PlayerUIPopUpManager>();
            uiPopUpManager.CloseInteractPopUp();
            player.playerAttackManager.usesUpgrade += 1;
